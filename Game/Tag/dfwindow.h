...
#define COMPONENT_STATE_COMMON 0  //组件正常状态
#define COMPONENT_STATE_ACTIVATE 1 //组件点击时激活状态
#define COMPONENT_STATE_DISABLE 2 //组件无效状态
...
#define GAME_WINDOW_MENU 0 //卡组菜单窗口
#define GAME_WINDOW_DECK 1 //卡组编辑窗口
#define GAME_WINDOW_MAX GAME_WINDOW_DECK + 1
}