...
#define TYPE_EFFECT			0x20		//效果
#define TYPE_FUSION			0x40		//融合
#define TYPE_RITUAL			0x80		//仪式
#define TYPE_TRAPMONSTER	0x100		//陷阱怪兽
#define TYPE_SPIRIT			0x200		//灵魂
#define TYPE_UNION			0x400		//同盟
#define TYPE_DUAL			0x800		//二重
#define TYPE_TUNER			0x1000		//调整
#define TYPE_SYNCHRO		0x2000		//同调
#define TYPE_TOKEN			0x4000		//衍生物
...
#define TYPE_FLIP			0x200000	//反转
#define TYPE_TOON			0x400000	//卡通
#define TYPE_XYZ			0x800000	//超量
#define TYPE_PENDULUM		0x1000000	//灵摆
#define TYPE_SPSUMMON		0x2000000	//特殊召唤
#define TYPE_LINK			0x4000000	//链接
}
